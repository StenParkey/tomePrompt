...
const interfaceObject = {
	...
	_useDeckDescriptions: {
		...
		quit: 'Cancel divination process..'
	},
	...
	_inspectDeckDescriptions: {
		...
		quit: 'Cancel the inspect proccess'
	},
...
export default async function tarotCardApp(user) {
